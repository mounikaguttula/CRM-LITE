...
import { CheckCircle2, AlertTriangle, Calendar, Clock, Sparkles, Send, Globe, HelpCircle, Mail } from 'lucide-react';
                  ...
                  >
                    ...
                    <div>
                      <a
                        ...
                        style={{
                          display: 'inline-flex', alignItems: 'center', gap: 8,
                          color: primaryColor, fontWeight: 700, fontSize: '0.95rem',
                          textDecoration: 'underline', transition: 'all 0.15s ease'
                        }}
                      >
                        <Mail size={16} />
